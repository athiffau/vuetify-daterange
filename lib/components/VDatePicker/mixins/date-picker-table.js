...
/* @vue/component */
    ...
    methods: {
        ...
        genButton: function genButton(value, isFloating, mouseEventType, formatter) {
            ...
            var isInRange = isDateInRange(value, this.value);
            var isRangeEnd = isRange && (value === this.value[1] || !isInRange && (value === this.value[0] && isHoverBeforeStartDate(this.value[0], this.hoverLink) || value === this.hovering && isHoverAfterStartDate(this.value[0], this.hoverLink)));
            var isRangeStart = isRange && !isRangeEnd && (value === this.value[0] || value === this.hovering && isHoverBeforeStartDate(this.value[0], this.hoverLink));
        ...
        getFinalColor: function getFinalColor(date, color) {
            ...
            var colorInRangeHover = Array.isArray(this.value) && this.value.length === 1 && typeof this.value[0] === 'string' && isDateInHoverRange(date, this.value[0], this.hoverLink);
